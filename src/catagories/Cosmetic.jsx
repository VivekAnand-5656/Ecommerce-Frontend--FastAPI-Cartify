            ...
            <div className="flex gap-8">
                ...
                <div className="w-[260px] bg-white/80 backdrop-blur-lg p-6 rounded-3xl shadow-lg h-fit sticky top-5">
                    ...
                    <input
                        ...
                        className="w-full p-3 border rounded-xl mb-5 focus:outline-none focus:ring-2 focus:ring-pink-400"
                    />
                        ...
                        filteredProducts.map(product => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="mt-4 bg-pink-500 hover:bg-pink-600 text-white py-2 rounded-xl font-semibold transition"
                                >
                                    Add to Cart
                                </button>
